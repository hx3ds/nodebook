...
export const controlEventHandler = {
    ...
    handleDarkModeToggle() {
        ...
        const toggleBtn = document.getElementById('proj-dark-mode-toggle');
        if (toggleBtn) {
            if (isDark) {
                toggleBtn.classList.add('active');
                toggleBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="16" height="16">
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.263l-1.591 1.591M3 12H5.25m.386-6.364L4.045 4.045M12 15a3 3 0 100-6 3 3 0 000 6z" />
</svg>`;
            } else {
